...
# TEST LVL
test = Level(size=(1382, 778), star_points = [1, 2, 3], time_remaining=60)
...
# LVL 2
lvl2 = Level(size=(1382, 778), star_points = [10, 17, 24], time_remaining=180)  # could reach max 22
# SPAWNERS
...
# LVL 3
lvl3 = Level(size=(1382, 778), time_remaining=180, star_points = [8, 13, 19])  # could reach max 18
# SPAWNERS
